...
public class SimpleCameraFollow : MonoBehaviour
{
    ...
    Color saveBaseHDRColor; //Цвет, который сохраняет начальные параметры цвета материала, чтобы потом от них отталкиваться
    ...
    void Start()
    {
        ...
        saveBaseHDRColor = directionSphereMaterial.GetColor("_GlowColor");
